...
#if  1//ndef CONFIG_HAS_EARLYSUSPEND	 //modified by hxh for DELL-255 start
static int kpd_pdrv_suspend(struct platform_device *pdev, pm_message_t state);
static int kpd_pdrv_resume(struct platform_device *pdev);
#endif   //modified by hxh for DELL-255 end
...
#if 1//ndef CONFIG_HAS_EARLYSUSPEND //modified by hxh for DELL-255 
static int kpd_pdrv_suspend(struct platform_device *pdev, pm_message_t state)
{
	kpd_suspend = true;
	...
	mt_set_gpio_mode(GPIO_KPD_KCOL0_PIN , GPIO_KPD_KCOL0_PIN_M_GPIO);
    	mt_set_gpio_dir(GPIO_KPD_KCOL0_PIN , GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_KPD_KCOL0_PIN , TRUE);
	mt_set_gpio_pull_select(GPIO_KPD_KCOL0_PIN , GPIO_PULL_DOWN);
	
	mt_set_gpio_mode(GPIO_KPD_KCOL1_PIN , GPIO_KPD_KCOL1_PIN_M_GPIO);
	...
	//mt_set_gpio_mode(GPIO_KPD_KROW0_PIN , GPIO_KPD_KROW0_PIN_M_GPIO);
  	...
  	//mt_set_gpio_out(GPIO_KPD_KROW0_PIN, GPIO_OUT_ONE);
   	...
   	//mt_set_gpio_mode(GPIO_KPD_KROW1_PIN , GPIO_KPD_KROW1_PIN_M_GPIO);
    	//mt_set_gpio_dir(GPIO_KPD_KROW1_PIN , GPIO_DIR_OUT);
    	//mt_set_gpio_out(GPIO_KPD_KROW1_PIN, GPIO_OUT_ONE);
...
{       
	kpd_suspend = false;
	//kpd_enable_backlight();
	mt_set_gpio_mode(GPIO_KPD_KCOL0_PIN , GPIO_KPD_KCOL0_PIN_M_KCOL);
   	mt_set_gpio_dir(GPIO_KPD_KCOL0_PIN , GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_KPD_KCOL0_PIN , TRUE);
	...
	//mt_set_gpio_mode(GPIO_KPD_KROW0_PIN , GPIO_KPD_KROW0_PIN_M_KROW);
  	//mt_set_gpio_dir(GPIO_KPD_KROW0_PIN , GPIO_DIR_OUT);

   	//mt_set_gpio_mode(GPIO_KPD_KROW1_PIN , GPIO_KPD_KROW1_PIN_M_KROW);
   	//mt_set_gpio_dir(GPIO_KPD_KROW1_PIN , GPIO_DIR_OUT);
