...
int FL_enable(void)
{
#if defined(GPIO_CAMERA_FLASH_EN_PIN)//  modify for flashlight led control by anxiang.xiao 2013-05-03
	...
	return 0;
#else
	// do nothing in case of control of the GPIO used by other module 
	#if 0
...
int FL_init(void)
{
#if 1//  modify for flashlight led control by anxiang.xiao 2013-05-03
	FL_disable();
