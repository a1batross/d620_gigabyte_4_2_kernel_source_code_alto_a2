...
//pengjinlong add for re-charging feature(J221_YULONG & D206_YULONG) (start)
#if defined (RGK_RECHG_TEMP_FOR_D206_YULONG) || defined (RGK_RECHG_TEMP_FOR_J221_YULONG)
#define MIN_CHARGE_TEMPERATURE  -6
#else
#define MIN_CHARGE_TEMPERATURE  0
#endif
//pengjinlong add for re-charging feature(J221_YULONG & D206_YULONG) (end)
